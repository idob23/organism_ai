...
- FIX-18: Bot denied its own scheduling and automation capabilities in conversation handler. Fixed: comprehensive self-knowledge system prompt with full capabilities list, explicit rules against redirecting users to external services for things the bot can do itself.
