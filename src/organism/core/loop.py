...
class CoreLoop:
    ...
    async def _handle_conversation(self, task_id: str, task: str, user_context: str = "", user_id: str = "default") -> "TaskResult":
        ...
        system = (
            ...
            "\n"
            "CRITICAL RULES:\n"
            "1. NEVER say you have no memory or that memory resets between sessions. This is FALSE.\n"
            "2. NEVER backtrack or apologize for correctly describing your capabilities. If you said something true, STAND BY IT.\n"
            "3. If a user challenges your capabilities, do NOT cave in. Politely reaffirm the truth.\n"
